...
PRODUCT_COPY_FILES += \\
    ...
    vendor/__VENDOR__/__DEVICE__/proprietary/lights.smba1006.so:system/lib/hw/lights.smba1006.so \\
    vendor/__VENDOR__/__DEVICE__/proprietary/sensors.default.so:system/lib/hw/sensors.default.so
    vendor/__VENDOR__/__DEVICE__/proprietary/sensors.smba1006.so:system/lib/hw/sensors.smba1006.so
    vendor/__VENDOR__/__DEVICE__/proprietary/sensors.goldfish.so:system/lib/hw/sensors.goldfish.so
